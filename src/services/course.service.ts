...
export const courseService = {
  ...
  create: (data: { title: string; description: string; createdBy: number }) => courseRepository.create(data),
  update: (id: number, data: Partial<{ title: string; description: string }>) => courseRepository.update(id, data),
