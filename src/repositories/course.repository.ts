...
export const courseRepository = {
  findAll: () => Course.findAll({ include: ['Creator', 'Modules'] }),
  findById: (id: number) => Course.findByPk(id, { include: ['Creator', 'Modules', 'EnrolledUsers'] }),
  ...
  findByTeacher: (teacherId: number) => Course.findAll({ where: { createdBy: teacherId } }),
};